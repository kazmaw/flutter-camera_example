...
class _HomeState extends State<Home> {
  ...
  Widget build(BuildContext context) {
    ...
    columChildren.add(new Row(children: headerChildren));
    if (controller == null || !controller.value.initialized) {
      columChildren.add(const Text('Tap a camera'));
    ...
    return new Scaffold(
      ...
      body: new Column(children: columChildren),
  ...
  /*
  * play&pauseボタン
  * Flat Buttonを設置し，押される度にStateを変更する
  */
  Widget playPauseButton() {
    ...
    }, child: new Icon(controller.value.isStarted ? Icons.pause : Icons.play_arrow));
  }
